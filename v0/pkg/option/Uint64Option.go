...
// NewMaybeUint64 creates a new option from the given
// pointer.
//
...
func (o Uint64) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Uint64) Get() uint64 {
	return o.OrPanicWithVal("attempted to unwrap an empty option of uint64")
}
...
// MapToNillable either returns an empty option of uint64
...
func (o Uint64) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
