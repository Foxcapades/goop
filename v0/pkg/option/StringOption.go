...
// NewMaybeString creates a new option from the given
// pointer.
//
...
func (o String) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o String) Get() string {
	return o.OrPanicWithVal("attempted to unwrap an empty option of string")
}
...
// MapToNillable either returns an empty option of string
...
func (o String) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
