...
// NewMaybeRune creates a new option from the given
// pointer.
//
...
func (o Rune) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Rune) Get() rune {
	return o.OrPanicWithVal("attempted to unwrap an empty option of rune")
}
...
// MapToNillable either returns an empty option of rune
...
func (o Rune) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
