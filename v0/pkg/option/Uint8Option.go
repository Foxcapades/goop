...
// NewMaybeUint8 creates a new option from the given
// pointer.
//
...
func (o Uint8) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Uint8) Get() uint8 {
	return o.OrPanicWithVal("attempted to unwrap an empty option of uint8")
}
...
// MapToNillable either returns an empty option of uint8
...
func (o Uint8) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
