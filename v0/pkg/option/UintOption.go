...
// NewMaybeUint creates a new option from the given
// pointer.
//
...
func (o Uint) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Uint) Get() uint {
	return o.OrPanicWithVal("attempted to unwrap an empty option of uint")
}
...
// MapToNillable either returns an empty option of uint
...
func (o Uint) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
