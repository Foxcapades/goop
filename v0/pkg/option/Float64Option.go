...
// NewMaybeFloat64 creates a new option from the given
// pointer.
//
...
func (o Float64) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Float64) Get() float64 {
	return o.OrPanicWithVal("attempted to unwrap an empty option of float64")
}
...
// MapToNillable either returns an empty option of float64
...
func (o Float64) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
