...
// NewMaybeInt16 creates a new option from the given
// pointer.
//
...
func (o Int16) OrPanicWith(fn func() interface{}) {
	if o.value == nil {
		panic(fn())
	}
}
...
func (o Int16) Get() int16 {
	return o.OrPanicWithVal("attempted to unwrap an empty option of int16")
}
...
// MapToNillable either returns an empty option of int16
...
func (o Int16) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
