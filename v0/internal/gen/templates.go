...
const Template = `// This package was generated from internal/gen/template @ {{ .Time }}
package option
...
{{ if eq $AltType "interface{}" }}
	...
	return New{{ $AltName }}(val){{ else }}	return New{{ $AltName }}(fn(*o.value)){{end}}
}
...
func (o {{ $.Name }}) isNil(v interface{}) bool {
	if v == nil {
		return true
	}
